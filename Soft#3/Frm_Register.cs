...
namespace App_
{
    ...
    {
        private SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\hp\Documents\data.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        private void signup_btn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!System.Text.RegularExpressions.Regex.IsMatch(email, @"^[^@\s]+@(gmail|hotmail|yahoo)\.com$", System.Text.RegularExpressions.RegexOptions.IgnoreCase))
                {
                    MessageBox.Show("Please enter a valid email address ending with gmail.com, hotmail.com, or yahoo.com.", "Invalid Email", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    signup_email.Focus();
                    return;
                }
            }
            ...
            else
            {
                ...
                using (SqlCommand checkUser = new SqlCommand(checkUsername, connect))
                {
                    ...
                    if (userExists > 0)
                    {
                        MessageBox.Show("Username is already taken. Please choose a different one.", "Username Unavailable", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        signup_username.Focus();
                        return;
                    }
                }
